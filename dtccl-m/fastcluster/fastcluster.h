...
struct cnode {
  ...
  */
  ...
  inline friend bool operator< (const cnode a, const cnode b) {
...
public:
  ...
  cnode * operator[] (const t_index idx) const { return Z + idx; }
